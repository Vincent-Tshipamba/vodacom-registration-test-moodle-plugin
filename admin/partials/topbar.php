<header
    ...
    <nav class="flex items-center justify-center">
        ...
        <a href="<?= new moodle_url('/local/scholarship/admin/interviews/') ?>" class="flex items-center gap-3 px-3 py-1 rounded-xl <?php if ($PAGE->url->get_path() === '/local/scholarship/admin/interviews/index.php'): ?> bg-blue-50 text-blue-600 font-semibold <?php else: ?> text-slate-600 hover:text-slate-900 font-medium <?php endif; ?>">
            <span>
